...
public class problem0011 {
	...
	public static int maxProduct(int[] nums) {
		...
		int firstMinValue = 99999999;
		int secondMinValue = 99999999;
		...
		for (int num : nums) {
			...
			else if (num >= firstMinValue && num < secondMinValue){
				secondMinValue = num;
			}
		}

		System.out.println(firstMaxValue);
		System.out.println(secondMaxValue);
		System.out.println(firstMinValue);
		System.out.println(secondMinValue);

    	return (firstMaxValue*secondMaxValue) - (firstMinValue*secondMinValue);
